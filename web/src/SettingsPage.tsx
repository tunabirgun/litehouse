...
const copy = {
  en: {
    ...
    balanced: "Balanced",
    quality: "Quality",
    citeHelp: "Browser reports render APA 7 in this release; your selection is recorded with each request. Inspect the verified offline compiler below.",
    ...
    appearanceHelp: "Theme and motion have a dedicated preview surface.",
    ...
    <main id="main-content" className="page lh-settings-page" tabIndex={-1}>
      ...
      <div className="lh-settings-shell">
        ...
        <section className="lh-settings-panel" id="settings-panel" aria-labelledby={`settings-heading-${section}`} key={section}>
          ...
          {section === "watches" && <WatchSettings c={c} />}
...
type SettingsCopy = (typeof copy)["en"];
...
function WatchSettings({ c }: { c: SettingsCopy }) {
